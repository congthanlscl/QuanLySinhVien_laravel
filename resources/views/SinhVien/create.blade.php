                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        @csrf
                                        <input type="text" name="id" id="id" class="form-control" placeholder="Nhập mã sinh viên">
                                        @error('id')
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="full_name" id="full_name" class="form-control" placeholder="Nhập tên sinh viên">
                                        @error('full_name')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="address" id="address" class="form-control" placeholder="Nhập địa chỉ sinh viên">
                                        @error('address')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
